...
receta('arroz_con_huevo','almuerzo',['arroz','huevo'],'ponga a hacer el huevo como si fuese a ser pateado y agrega el arroz',['arrozconuevo.png']).
receta('sopa_negra','cena',['frijoles','huevo'],'haga frijoles y agregue el huevo sin pelar para que se ponga duro', ['sopanegra.png']).
receta('cereal', 'desayuno',['cereal','leche'],'ponga el cereal en un plato hondo y agregue la leche',['cereal.png']).
receta('macarrones','almuerzo',['espaguetti','salsa_de_tomate','queso'],'cocine los espaguetties, agregue la salsa y luego el queso',['macarrones.png']).
receta('arepas','desayuno',['leche','polvito_de_arepa','azucar','huevo'],'haga una masa con el polvo, la leche y el huevo, agrega azucar al gusto y frie arepitas en el sarten',['arepa.png']).
